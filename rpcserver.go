...
func (r *rpcServer) parseOpenChannelReq(in *lnrpc.OpenChannelRequest,
	...
	// We restrict the max length of the channel memo to 500 characters so
	// as to set a reasonable limit on the storage space consumption. This
	// also mimics the length limit enforced for a TX label.
